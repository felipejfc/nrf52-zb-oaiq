 ...
 */
EXTERNC int battery_set_fast_charge(void);
 ...
 * @retval 0 if successful. Negative errno number on error.
 */
EXTERNC int battery_set_slow_charge(void);
 ...
 * @retval 0 if successful. Negative errno number on error.
 */
EXTERNC int battery_charge_start(void);
 ...
 */
EXTERNC int battery_charge_stop(void);
 ...
 * @retval 0 if successful. Negative errno number on error.
 */
EXTERNC int battery_get_millivolt(uint16_t *battery_millivolt);
 ...
 * @retval 0 if successful. Negative errno number on error.
 */
EXTERNC int battery_get_percentage(uint8_t *battery_percentage, uint16_t battery_millivolt);
 ...
 * @retval 0 if successful. Negative errno number on error.
 */
EXTERNC int battery_init(void);

EXTERNC int battery_disable_pins();
EXTERNC int battery_enable_pins();
